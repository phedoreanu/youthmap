...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'About'
        db.create_table(u'youth_about', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('about', self.gf('django.db.models.fields.TextField')()),
            ('contact_name', self.gf('django.db.models.fields.TextField')()),
            ('contact_title', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('contact_email', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal(u'youth', ['About'])


    def backwards(self, orm):
        # Deleting model 'About'
        db.delete_table(u'youth_about')
    ...
    models = {
        ...
        u'youth.about': {
            ...
            'contact_email': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
