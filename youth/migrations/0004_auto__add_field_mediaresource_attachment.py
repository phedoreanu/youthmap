...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaResource.attachment'
        db.add_column(u'youth_mediaresource', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaResource.attachment'
        db.delete_column(u'youth_mediaresource', 'attachment')
